...
multi = MultiCursor(fig.canvas, axlist[0:2], horizOn=True, vertOn=True, color='r', lw=1.2)
...
apds = [mpf.make_addplot(exp12,color='lime',ax=axlist[0]),
        ...
        mpf.make_addplot(histogram,type='bar',width=0.7,panel=1,ax=axlist[2],
                         color='dimgray',alpha=1,secondary_y=False),
        mpf.make_addplot(macd,panel=1,color='fuchsia',secondary_y=True,ax=axlist[3]),
        mpf.make_addplot(signal,panel=1,color='b',secondary_y=True,ax=axlist[3])
       ]
